        ...
        <div className="section secCard">  
            <Container>
                <div className="navSec">
                    <ul className='navSecList'>
                        <li className='navSecItem active'>Show ALL</li>
                        <li className='navSecItem'>Apartment</li>
                        <li className='navSecItem'>Villa House</li>
                        <li className='navSecItem'>Penthouse</li>
                    </ul>
                </div>
                <Row>
                        {
